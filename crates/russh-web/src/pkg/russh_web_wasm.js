...
function __wbg_adapter_26(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1a6d948286077fb3(arg0, arg1, addHeapObject(arg2));
}

function __wbg_adapter_35(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd09b53dc009eb7d4(arg0, arg1, addHeapObject(arg2));
}
...
*/
export function init_client(status, info, error, binary) {
    wasm.init_client(addHeapObject(status), addHeapObject(info), addHeapObject(error), addHeapObject(binary));
}
...
*/
export function connect(mode, ws_url, host, port, user, password, identity_seed_hex) {
    ...
    const ptr4 = passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len4 = WASM_VECTOR_LEN;
    const ptr5 = passStringToWasm0(identity_seed_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len5 = WASM_VECTOR_LEN;
    const ret = wasm.connect(ptr0, len0, ptr1, len1, ptr2, len2, port, ptr3, len3, ptr4, len4, ptr5, len5);
...
* @returns {Promise<void>}
*/
export function send_input(bytes) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.send_input(ptr0, len0);
    return takeObject(ret);
}
...
* @returns {boolean}
*/
export function is_connecting() {
    const ret = wasm.is_connecting();
    return ret !== 0;
}
...
function __wbg_adapter_92(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h2502ffd0f626fb35(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('russh_web_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
